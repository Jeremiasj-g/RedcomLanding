...
export const corrientesRefrigerados = [
  ...
  },
  {
    id: 8,
    title: 'Tablero',
    description: 'Tablero de información análitica del ultimo trimestre cerrado.',
    image: '../tablero.jpg',
    category: 'Tablero',
    link: '',
  },
...
export const chacoProducts = [
  ...
  },
  {
    ...
    image: 'tablero.jpg',
    category: 'Tablero',
    link: 'https://1drv.ms/x/c/e002e7d72e5a47f0/IQSwRGxyNCSPQKeIrsOi4rUwAY6xCEk1Of1ZUvtkNxxgILA?em=2&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True',
  },
  {
    id: 8,
    title: 'Avance objetivos',
...
export const misionesProducts = [
  ...
  },
  {
    ...
    image: 'tablero.jpg',
    category: 'Tablero',
    link: 'https://1drv.ms/x/c/e002e7d72e5a47f0/IQQRI-bVVQpwRLxG8sAZCVwPAXH0rGkY_y6XRxy6IL7DpEY?em=2&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True',
  },
];
...
export const oberaProducts = [
  ...
  },
  {
    ...
    image: 'tablero.jpg',
    category: 'Tablero',
    link: 'https://1drv.ms/x/c/e002e7d72e5a47f0/IQQ1MzA4uAspQpdF3KpiNYu8AYnQPG8QsrflDtSFX6l1kNY?em=2&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True',
  },
];
...
export const gerenciaProducts = [
  {
    ...
    image: 'tablero.jpg',
    category: 'Tablero',
    link: 'https://1drv.ms/x/c/e002e7d72e5a47f0/IQQ-35p-nqhjR5X1T2kfoRw_AXn9erZfrg7mZxNiuLaur_o?em=2&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True',
  },
];
  ...
  mapas: [
    {
      corrientes: {
        ...
        embedUrl: "https://www.google.com/maps/d/u/0/embed?mid=1dswZoPN46Tw75GZOd2latT9AdKe0y8M&ehbc=2E312F",
  ...
  tableros: [
    {
      corrientes: {
        ...
        embedUrl: "https://1drv.ms/x/c/e002e7d72e5a47f0/IQQoewkVoJUwT7wH4gCkZgehAWPDRl70ojj9zfvzo5az3i8?em=2&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True&wdInConfigurator=True",
    ...
    },
    {
      gerencia: {
        title: "Tablero de Corrientes",
        description: "Visualizá el tablero trimestral de Corrientes",
        embedUrl: "https://onedrive.live.com/edit?cid=e002e7d72e5a47f0&id=E002E7D72E5A47F0!s7e9adf3ea89e476395f54f691fa11c3f&resid=E002E7D72E5A47F0!s7e9adf3ea89e476395f54f691fa11c3f&ithint=file%2Cxlsx&embed=1&em=2&wdHideGridlines=True&wdHideHeaders=True&wdDownloadButton=True&wdInConfigurator=True%2CTrue&migratedtospo=true&redeem=&wdo=2",
        buttonLabel: "Abrir tablero",
        accentColor: "#FFF6BD"
      }
    },
