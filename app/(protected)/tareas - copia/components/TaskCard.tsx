...
export default function TaskCard({
  ...
  return (
    <div
      ...
      className="group cursor-pointer rounded-xl border border-slate-800 bg-gray-700/70 p-2 text-xs text-slate-100 shadow-sm shadow-slate-950/60 hover:border-sky-500/70 hover:bg-gray-700 transition-transform"
    >
      {/* Header */}
      <div className="mb-1 flex items-center justify-between gap-2">
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            {...attributes}
            {...listeners}
            className="cursor-grab active:cursor-grabbing rounded-md bg-slate-900/60 p-1 text-slate-400 hover:bg-slate-800 hover:text-slate-100"
            title="Arrastrar"
          >
